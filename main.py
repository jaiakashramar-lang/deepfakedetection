...
video_model_path = r"C:\Users\jaiak\Desktop\projects\test\deepfake\models\video_model\deepfake.h5"
video_proto_path = r"C:\Users\jaiak\Desktop\projects\test\deepfake\models\video_model\deploy.prototxt"
video_dnn_model = r"C:\Users\jaiak\Desktop\projects\test\deepfake\models\video_model\res10_300x300_ssd_iter_140000.caffemodel"
...
def predict_face(face):
    ...
    preprocessed = preprocess_frame(face)
    pred = video_model.predict(preprocessed, verbose=0)
    return float(pred[0][0])  # Convert to Python float
